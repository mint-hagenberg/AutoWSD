        ...
        private void Update()
        {
            ...
            if (m_StartedSound)
            {
                ...
                else
                {
                    ...
                    m_LowAccel.volume = lowFade * accFade * 0.5f;
                    m_LowDecel.volume = lowFade * decFade * 0.5f;
                    m_HighAccel.volume = highFade * accFade * 0.5f;
                    m_HighDecel.volume = highFade * decFade * 0.5f;
